...
#' @export
#'
convert_to_rows <- function(in_data, start_col_name="X1981", end_col_name="X2015") {
...
#' @export
#'
create_infile <- function(pop_data_source, index_vector=TRUE, name="default_infile", start_col_name="X1981", end_col_name="X2015", CUT_OFF_YEAR = 1950) {
