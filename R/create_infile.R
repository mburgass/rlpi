...
#' @export
#'
convert_to_rows <- function(in_data, start_col_name="X1950", end_col_name="X2102") {
...
#' @export
#'
create_infile <- function(pop_data_source, index_vector=TRUE, name="default_infile", start_col_name="X1950", end_col_name="X2102", CUT_OFF_YEAR = 1950) {
