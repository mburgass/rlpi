...
#' @export
#'
convert_to_rows <- function(in_data, start_col_name="X1980", end_col_name="X2068") {
...
#' @export
#'
create_infile <- function(pop_data_source, index_vector=TRUE, name="default_infile", start_col_name="X1980", end_col_name="X2068", CUT_OFF_YEAR = 1950) {
